...
var uiController = (function() {
    ...
    return {
        ...
        displayPercentages: function(allPercentages) {
            ...
            // Элемент болгоны хуьд зарлагын хувийг массиваас авч шивж оруулах
        ...
        addListItem: function(item, type){
            // Орлого ззарлагын элементийг агуулсан html-ийг бэлтгэнэ.
            var html, list;
            if (type === "inc") {
            ...
            // Тэр HTML дотроо олрлого зарлагын утгуудыг REPLACE ашиглаж өөрчөлж өгнө
...
var appController = (function(uiController, financeController) {
    var ctrlAddItem = function(){
        // 1. Оруулж өгөгдлийг дэлгэцээс олж авна.
        var input = uiController.getInput();

        if(input.description !== "" && input.value !== ""){
            // 2. Олж авсан өгөгдлүүдээ санхүүгийн контрллерт дамжуулж тэнд хадгална.
    ...
    var setupEventListeners = function() {        
        ...
        document.querySelector(DOM.containerDiv).addEventListener("click", function(event){
            ...
            if(id){// id mon bol true bolood ajillna
                // inc-2
                var arr = id.split("-");
                var type = arr[0];
